...
<body>
  ...
  <div class="container">
    <div class="block-red">
      <div class="row">
        <div class="col-1">
          <a href="articles.php"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
        </div>
        <div class="col-11">
          <h2 class="cyber-h2"><?php echo $article['title'] ?></h2>
          <h6 class="cyber-h6"><?php echo $article['date'] ?></h6>
        </div>
      </div>
      <br>
      <img src="<?php echo $article['image'] ?>" class="img-fluid img-shadow img_cyber_full">
      <br>
      <br>
      <br>
      <p class="cyber-p" style="font-size: 18px"><?php echo $article['text']; ?></p>
      <br>
      <div class="text-left">
        <p class="text-right cyber-ps">Опубликовано: <?php echo $article['creator'] ?></p>
      </div>
    </div>
  </div>
